...
<section class="Card">
  <div class="Card-segment">
    <div class="u-fs--1 u-case--upper u-margin-b-e--lg">
      Gender reassignment harassment claim
    </div>
    ...
    <div class="Card-lede">
      ...
      <p>For example:</p>
      <p>
        “I was forced to resign after being bullied by my line manager over a
        6-month period, with no support from the Respondent after I raised my
        concerns with HR.”
      </p>
    </div>
    ...
    <p class="u-margin-b-s--lg">
      This claim will be saved as <b>Gender reassignment harassment</b>
    </p>
  </div>
  <div class="Card-segment">
    <div class="Notice">End of prototype</div>
